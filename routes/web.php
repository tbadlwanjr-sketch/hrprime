...
Route::prefix('qualifications')->group(function () {
  Route::post('/store/{positionId}', [QualificationController::class, 'store'])->name('qualifications.store');
  Route::get('/position/{positionId}', [QualificationController::class, 'getByPosition'])->name('qualifications.byPosition');
  Route::put('/{id}', [QualificationController::class, 'update'])->name('qualifications.update');
  Route::delete('/{positionId}/{qualificationId}', [QualificationController::class, 'destroy'])->name('qualifications.destroy');
});
//Salary Grade
...
Route::prefix('planning')->group(function () {
  Route::get('item-numbers', [ItemNumberController::class, 'index'])->name('item-numbers.index');
  Route::post('item-numbers', [ItemNumberController::class, 'store'])->name('item-numbers.store');
  Route::put('item-numbers/{id}', [ItemNumberController::class, 'update'])->name('item-numbers.update');
  Route::delete('item-numbers/{id}', [ItemNumberController::class, 'destroy'])->name('item-numbers.destroy');
});
//Position
...
Route::prefix('requirements')->group(function () {
  Route::post('/store/{positionId}', [RequirementController::class, 'store'])->name('requirements.store');
  Route::delete('/{id}', [RequirementController::class, 'destroy'])->name('requirements.destroy');
  Route::get('/position/{positionId}', [RequirementController::class, 'getByPosition'])->name('requirements.byPosition');
  Route::put('/{id}', [RequirementController::class, 'update'])->name('requirements.update'); // ✅ fixed
});

Route::prefix('qualifications')->group(function () {
  Route::post('/store/{positionId}', [QualificationController::class, 'store'])->name('qualifications.store');
  Route::put('/{id}', [QualificationController::class, 'update'])->name('qualifications.update');
  Route::delete('/{id}', [QualificationController::class, 'destroy'])->name('qualifications.destroy');
  Route::get('/position/{positionId}', [QualificationController::class, 'getByPosition'])->name('qualifications.byPosition');
});
//-------------------------------------------------------END OF PLANNING-----------------------------------------------------------
